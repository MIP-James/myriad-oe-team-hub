      ...
      for (let i = 0; i < sections.length; i++) {
        ...
        const canvas = await html2canvas(el, {
          ...
          onclone: (cdoc) => {
            ...
            st.textContent = '.mr-bartrack{overflow:visible !important;transform:translateY(6px)} .mr-kpis>div>div{transform:translateY(-8px)} .mr-kpis>div>.mr-serif{transform:translateY(-14px)} .mr-kpis>div>div:last-child{transform:translateY(-3px)} .mr-weeksub{transform:translateY(18px)}'
