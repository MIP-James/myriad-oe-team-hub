  ...
  return (
    <div className="mr-chartcard" style={{ marginTop: 30 }}>
      ...
      <div style={{ marginBottom: 12 }}>
        <h3 className="mr-serif" style={{ margin: 0, fontSize: 16, fontWeight: 600, color: C.ink }}><span style={{ display: 'inline-block', width: 6, height: 6, background: C.amber, marginRight: 8, verticalAlign: 'middle' }} />{title} <span style={{ fontSize: 11, color: '#A39C8C', fontWeight: 500 }}>{en}</span></h3>
      </div>
      {items.map((p, i) => (
  ...
  return (
    <div className="mr-chartcard" style={{ marginTop: 30 }}>
      <div style={{ marginBottom: 10 }}>
        <h3 className="mr-serif" style={{ margin: 0, fontSize: 16, fontWeight: 600, color: C.ink }}><span style={{ display: 'inline-block', width: 6, height: 6, background: C.amber, marginRight: 8, verticalAlign: 'middle' }} />침해유형별 분포 <span style={{ fontSize: 11, color: '#A39C8C', fontWeight: 500 }}>By Infringement Type</span></h3>
      </div>
      ...
      {items.map((t, i) => (
        <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 11, padding: '6px 0', borderBottom: '1px solid #EFEADD' }}>
          <div style={{ flex: 1, fontSize: 12.5, color: '#332F27' }}><span style={{ display: 'inline-block', width: 10, height: 10, borderRadius: 2, background: t.col, marginRight: 11, verticalAlign: 'middle' }} />{t.ko} <span style={{ color: '#A39C8C', fontSize: 10 }}>{t.en}</span></div>
